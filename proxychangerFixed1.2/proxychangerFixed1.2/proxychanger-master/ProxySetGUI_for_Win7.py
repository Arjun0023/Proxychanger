...
class setProxy(object):
    def __init__(self):
        ...
        self.lable = tkinter.Label(self.root, text="The proxy file name is proxy.txt by default")
        ...
        self.original_proxy = "http://proxy.cn.svc.corpintra.net/proxy.pac"
    ...
    def enableProxy(self):       
        file = "proxychangerFixed1.2\proxy.txt"
    ...
    #-------------------------------------------------------
        ...
        time.sleep(1)
        PS.PressKey(PS.VK_CONTROL)
        PS.press(PS.VK_TAB)
        PS.press(PS.VK_TAB)
        PS.press(PS.VK_TAB)
        PS.press(PS.VK_TAB)
        PS.ReleaseKey(PS.VK_CONTROL)
        PS.press(PS.VK_TAB)
        PS.press(PS.VK_TAB)
        PS.press(PS.VK_TAB)
        PS.press(PS.VK_TAB)
